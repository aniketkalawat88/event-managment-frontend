        ...
        <div className="lg:w-1/2">
          <div className="lg:pr-32 xl:pr-48">
            <h3 className="text-3xl font-semibold leading-tight">
              Efficient Event Management Solutions
            </h3>
            <p className="mt-8 text-xl font-light leading-relaxed">
              Our event management services are designed to streamline the planning and execution of both small and large-scale events. From conferences to corporate events
            </p>
            <p className="mt-4 text-xl font-light leading-relaxed">
              {`Whether it's a business conference, a wedding, or a product launch, we handle the details so you can focus on your guests and objectives. Our services include event planning, venue coordination, catering, entertainment, and much more. We take care of the logistics, allowing you to enjoy a stress-free event.`}
            </p>
          </div>
        </div>
        <div className="mt-10 lg:mt-0 w-full lg:w-1/2 flex justify-center"> <svg
          data-name="Layer 1"
