        ...
        <div className="lg:w-1/2">
          <div className="lg:pr-32 xl:pr-48">
            <h3 className="text-3xl font-semibold leading-tight">
              {`Optimize Your Event's Performance with Precision`}
            </h3>
            <p className="mt-8 text-xl font-light leading-relaxed">
              With detailed insights and data-driven analysis, we provide you with an actionable plan to enhance the performance of your event. From attendee engagement to vendor coordination, we identify key areas of improvement to ensure smooth and efficient event execution.
            </p>
            <p className="mt-4 text-xl font-light leading-relaxed">
              Our team uses advanced tools to monitor and track performance metrics, optimizing every aspect of the event to drive better results and achieve your goals.
            </p>
          </div>
        </div>
